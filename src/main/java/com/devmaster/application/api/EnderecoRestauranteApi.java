...
public interface EnderecoRestauranteApi {
    ...
    ResponseEntity<EnderecoRestauranteResponse> findById(@PathVariable Integer id);
    ...
    ResponseEntity<List<EnderecoRestauranteResponse>> findAllByRestauranteId(@PathVariable Integer id);
