...
@RequestMapping({"/public/v1/restaurantes/{restauranteId}/tipos-pagamento", "/public/v2/restaurantes/{restauranteId}/tipos-pagamento"})
public interface TipoPagamentoPublicoAPI {
    ...
    ResponseEntity<List<RestauranteTipoPagamentoResponse>> listarTiposPagamentoRestaurante(
