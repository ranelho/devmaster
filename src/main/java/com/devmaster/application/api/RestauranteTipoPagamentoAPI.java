...
@RequestMapping({"/v1/restaurantes/{restauranteId}/tipos-pagamento", "/v2/restaurantes/{restauranteId}/tipos-pagamento"})
...
public interface RestauranteTipoPagamentoAPI {
    ...
    ResponseEntity<RestauranteTipoPagamentoResponse> vincularTipoPagamento(
    ...
    ResponseEntity<List<RestauranteTipoPagamentoResponse>> listarTiposPagamento(
        @Parameter(description = "ID do restaurante") @PathVariable Long restauranteId
    );
    ...
    ResponseEntity<Void> desvincularTipoPagamento(
        @Parameter(description = "ID do restaurante") @PathVariable Long restauranteId,
