...
@RequestMapping({"/public/v1/clientes/{clienteId}/enderecos", "/public/v2/clientes/{clienteId}/enderecos"})
public interface EnderecoClienteAPI {
    ...
    ResponseEntity<EnderecoClienteResponse> adicionarEndereco(
    ...
    ResponseEntity<List<EnderecoClienteResponse>> listarEnderecos(
        @Parameter(description = "ID do cliente") @PathVariable Long clienteId
    );
    
    @GetMapping("/{enderecoId}")
    @Operation(summary = "Buscar endereço", description = "Busca endereço específico")
    ResponseEntity<EnderecoClienteResponse> buscarEndereco(
        @Parameter(description = "ID do cliente") @PathVariable Long clienteId,
    ...
    ResponseEntity<EnderecoClienteResponse> buscarEnderecoPadrao(
        @Parameter(description = "ID do cliente") @PathVariable Long clienteId
    );
    
    @PutMapping("/{enderecoId}")
    @Operation(summary = "Atualizar endereço", description = "Atualiza dados de um endereço")
    ResponseEntity<EnderecoClienteResponse> atualizarEndereco(
        @Parameter(description = "ID do cliente") @PathVariable Long clienteId,
        @Parameter(description = "ID do endereço") @PathVariable Long enderecoId,
        @Valid @RequestBody EnderecoClienteRequest request
    );
    ...
    ResponseEntity<EnderecoClienteResponse> definirEnderecoPadrao(
        @Parameter(description = "ID do cliente") @PathVariable Long clienteId,
        @Parameter(description = "ID do endereço") @PathVariable Long enderecoId
    );
    ...
    ResponseEntity<Void> removerEndereco(
        @Parameter(description = "ID do cliente") @PathVariable Long clienteId,
        @Parameter(description = "ID do endereço") @PathVariable Long enderecoId
    );
}
