...
public interface DashboardAPI {
    ...
    ResponseEntity<List<PedidoResumoResponse>> buscarPedidosNovos(@PathVariable Long restauranteId);
    ...
    ResponseEntity<List<PedidoResumoResponse>> buscarPedidosEmPreparo(@PathVariable Long restauranteId);
    ...
    ResponseEntity<List<PedidoResumoResponse>> buscarPedidosProntos(@PathVariable Long restauranteId);
    ...
    ResponseEntity<List<PedidoResumoResponse>> buscarPedidosEmEntrega(@PathVariable Long restauranteId);
    ...
    ResponseEntity<String> gerarComandaHTML(@PathVariable Long pedidoId);
    ...
    ResponseEntity<byte[]> gerarComandaPDF(@PathVariable Long pedidoId);
    ...
    ResponseEntity<DashboardMetricasResponse> buscarMetricas(
        @PathVariable Long restauranteId,
        @RequestParam(required = false) @DateTimeFormat(iso = DateTimeFormat.ISO.DATE) LocalDate data
    );
    ...
    ResponseEntity<List<ResumoStatusResponse>> buscarResumoStatus(@PathVariable Long restauranteId);
}
