...
public class PedidoApplicationService implements PedidoService {
    ...
    public PedidoResponse criarPedido(UUID usuarioId, PedidoRequest request) {
        ...
        registrarHistorico(pedido, StatusPedido.PENDENTE, "Pedido criado", usuarioId.toString());
    ...
    public PedidoResponse atualizarStatus(UUID usuarioId, Long pedidoId, AtualizarStatusPedidoRequest request) {
        ...
        pedido = pedidoRepository.save(pedido);
        registrarHistorico(pedido, request.status(), request.observacoes(), usuarioId.toString());
    ...
    public void confirmarPedido(UUID usuarioId, Long pedidoId) {
        ...
        registrarHistorico(pedido, StatusPedido.CONFIRMADO, null, usuarioId.toString());
    }
    ...
    public void iniciarPreparo(UUID usuarioId, Long pedidoId) {
        ...
        pedidoRepository.save(pedido);
        registrarHistorico(pedido, StatusPedido.PREPARANDO, null, usuarioId.toString());
    }
    ...
    public void marcarComoPronto(UUID usuarioId, Long pedidoId) {
        ...
        pedidoRepository.save(pedido);
        registrarHistorico(pedido, StatusPedido.PRONTO, null, usuarioId.toString());
    }
    ...
    public void despacharPedido(UUID usuarioId, Long pedidoId) {
        ...
        pedido.despachar();
        pedidoRepository.save(pedido);
        registrarHistorico(pedido, StatusPedido.DESPACHADO, null, usuarioId.toString());
    }
    ...
    public void entregarPedido(UUID usuarioId, Long pedidoId) {
        ...
        pedido.entregar();
        pedidoRepository.save(pedido);
        registrarHistorico(pedido, StatusPedido.ENTREGUE, null, usuarioId.toString());
    }
    ...
    public void cancelarPedido(UUID usuarioId, Long pedidoId, CancelarPedidoRequest request) {
        ...
        pedidoRepository.save(pedido);
        registrarHistorico(pedido, StatusPedido.CANCELADO, request.motivo(), usuarioId.toString());
    }
    ...
    private void validarGruposObrigatorios(Long produtoId, List<OpcaoItemRequest> opcoesRequest) {
        ...
        for (GrupoOpcao grupo : gruposObrigatorios) {
            ...
            long quantidadeSelecionada = opcoesRequest.stream()
                .filter(o -> o.grupoOpcaoId().equals(grupo.getId()))
                .count();
