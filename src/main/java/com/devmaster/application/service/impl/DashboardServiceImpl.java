...
public class DashboardServiceImpl implements DashboardService {
    ...
    public DashboardServiceImpl(PedidoRepository pedidoRepository, @Lazy DashboardService self) {
    ...
    public DashboardResponse buscarDashboardCompleto(Long restauranteId, LocalDate data) {
        return DashboardResponse.builder()
                .metricas(self.buscarMetricas(restauranteId, data))
                .resumo(self.buscarResumoStatus(restauranteId))
                .novos(self.buscarPedidosNovos(restauranteId))
                .preparo(self.buscarPedidosEmPreparo(restauranteId))
                .prontos(self.buscarPedidosProntos(restauranteId))
                .entrega(self.buscarPedidosEmEntrega(restauranteId))
                .build();
    }
